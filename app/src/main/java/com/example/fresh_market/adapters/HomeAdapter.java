package com.example.fresh_market.adapters;
...
import com.example.fresh_market.activities.ViewAllActivity;
...
public class HomeAdapter extends RecyclerView.Adapter<HomeAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.home_cats_item,parent,false));
    }
